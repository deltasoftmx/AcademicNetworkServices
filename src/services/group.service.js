 ...
 */
async function searchGroups(groupRelativeType = 'all', search = '', offset = 10, page = 0, asc = 1, userId) {
  let query = `
    SELECT 
      user_groups.id,
      user_groups.name,
 ...
 *  * message: string
 */
async function switchGroupNotifications(userId, group_id, state) {
  try {
 ...
 */
async function updateGroupImage(group_id, image, userId) {
